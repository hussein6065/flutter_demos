...
class CallService {
  ...
  void _configureAudioDevices() async {
    try {
      ...
      _activeAudioDevice = VIAudioDevice.Speaker;
      selectAudioDevice(device: VIAudioDevice.Speaker);
    ...
    _audioDeviceManager.onAudioDeviceChanged = (_, device) {
      _activeAudioDevice =
          device == VIAudioDevice.Earpiece ? VIAudioDevice.Speaker : device;
      // _activeAudioDevice = device;
      selectAudioDevice(device: activeAudioDevice);
    };
